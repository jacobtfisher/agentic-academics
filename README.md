...
Each guide is standalone — start wherever you're most curious.
...
The `examples/` folder contains generalized templates you can adapt to your own setup:

- **[CLAUDE.md templates](examples/claude-md/)** — for solo researchers and lab groups
- **[Skill templates](examples/skills/)** — literature notes, daily reviews, data codebooks
- **[MCP configurations](examples/mcp-configs/)** — setup guides for academic tools
